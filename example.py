...
while 1:
    ...
    #range_result_list.append(rangeResult)

    #dopplerResult = dopplerFFT(rangeResult)
    #doppler_result_list.append(dopplerResult)
...
result = {"pointcloud":point_cloud_list, "rangeresult":range_result_list, "doppler_result":doppler_result_list}

#fileobj = open("data.pkl", "wb")
